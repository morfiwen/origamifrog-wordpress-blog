  ...
  <div class="container">
    <div class="blog-grid">
      <div class="blog-column">
        ...
        <div class="tile">
					<?php if ( is_day() ) : ?>
					                <h2 class="page-title"><?php printf( __( 'Archiwum: <span>%s</span>' ), get_the_time(get_option('date_format')) ) ?></h2>
					<?php elseif ( is_month() ) : ?>
					                <h2 class="page-title"><?php printf( __( 'Archiwum: <span>%s</span>' ), get_the_time('F Y') ) ?></h2>
					<?php elseif ( is_year() ) : ?>
					                <h2 class="page-title"><?php printf( __( 'Archiwum: <span>%s</span>' ), get_the_time('Y') ) ?></h2>
					<?php elseif ( isset($_GET['paged']) && !empty($_GET['paged']) ) : ?>
					                <h2 class="page-title"><?php _e( 'Archiwum' ) ?></h2>
					<?php endif; ?>
				</div>
